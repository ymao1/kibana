...
- "Get the latest entity risk score for this user and the inputs that contributed to the calculation."
- "How long has this entity been active?"`,
    ...
    handler: async ({ identifierType, identifier }, { request, esClient }) => {
          ...
          results: [
            {
              ...
              type: ToolResultType.error,
              data: {
                message: `Error fetching entity profile: ${error.message}`,
              },
            },
          ],
        };
