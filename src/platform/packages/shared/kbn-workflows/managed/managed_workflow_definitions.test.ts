...
const templateRepresentativeValuesById: ManagedWorkflowTemplateValuesById = {
  ...
  [PND_WATCH_FLOOR_WORKFLOW_ID]: PND_WATCH_TEMPLATE_VALUES[PND_WATCH_FLOOR_WORKFLOW_ID],
  [PND_WATCH_OFFICER_WORKFLOW_ID]: PND_WATCH_TEMPLATE_VALUES[PND_WATCH_OFFICER_WORKFLOW_ID],
  [PND_WATCH_DARK_WORKFLOW_ID]: PND_WATCH_TEMPLATE_VALUES[PND_WATCH_DARK_WORKFLOW_ID],
  [PND_WATCH_DEEP_WORKFLOW_ID]: PND_WATCH_TEMPLATE_VALUES[PND_WATCH_DEEP_WORKFLOW_ID],
};
